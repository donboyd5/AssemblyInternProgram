...
format:
  revealjs:
    ...
    chalkboard:
      buttons: false
    preview-links: auto
    theme: [white, djb.scss] # use white, with modifications; default also ok
  pdf:
    toc: false
execute:
  echo: true  
...
# Influencers, advocates, interest groups
...
## Stylized view of influencers, especially re: the budget
...
## Possible final discussion items {.smaller}

-   Cycle 4 (3 lectures/classes, student choice) -- I'm thinking maybe

    -   K12 education and education finance in NY as topic

        -   1 or 2 classes would bring in people who have played a prominent role in NY, inside or outside of govt, (if I can get them) for remarks then discussion with students

        -   the other 1-2 classes would be lecture

    -   or instead, 3 classes, each of which has 1-2 people who have played prominent roles in New York policy, different issues (again, if I can get them)

    -   feedback welcome - ok to put in the [Google doc](https://docs.google.com/document/d/1ymJzG2t4sdk8OEuFKtG7LoNw2M9ntNwTbSB9YDwH7WI/edit?usp=sharing)

-   Research paper - do we need to discuss any questions about how to approach it?
