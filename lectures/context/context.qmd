...
format:
  revealjs:
    ...
    chalkboard:
      buttons: false
    preview-links: auto
    theme: [white, djb.scss] # use white, with modifications
    # theme: white # [custom3.scss] # white default; these are the 2 ok built-ins
  # pdf:
  #   toc: false    
execute:
  echo: true  
...
**U.S. Supereme Court ruled legislature cannot impose tax on NJ/CT commuters to NYC, while not imposing tax on Westchester/Nassau commuters to NYC**
...
-   City & State articles (required reading) provided information on prominent lobbyists and advocates
...
Some great books and papers in the resources folder.
